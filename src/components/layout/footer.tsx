      ...
      <footer className="bg-gradient-to-b from-[#003da3] to-[#001f52] text-white relative pb-24">
        ...
        <div className="px-6 pt-10 pb-6">
          ...
          <div className="flex space-x-3 mb-8">
            ...
            <a href="#" className="w-9 h-9 bg-white/10 hover:bg-brand-orange rounded-lg flex items-center justify-center transition-all" aria-label="Instagram">
          ...
          {/* Links sections in 2-column grid */}
          <div className="grid grid-cols-2 gap-6 mb-8">
            ...
            {/* Soporte */}
            <div>
              <h4 className="text-xs font-extrabold uppercase tracking-widest text-brand-orange mb-4">{dict.footer.supportSection}</h4>
              <ul className="space-y-2.5">
