...
export default async function ProtejaSuaRedePage(props: { params: Promise<{ lang: string }> }) {
  const params = await props.params;
  const lang = params.lang as Locale;
  const dict = await getDictionary(lang);
  
  const post = dict.blogPosts.blogPost3;
    ...
    <>
      <section className="pt-28 pb-16 bg-white">
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <YouTubePlayer
            thumbnailSrc={dict.newLayout.blogPost3Img}
            videoId="g_ri8jTaiBw"
            alt={post.title}
          />
          ...
          <div className="prose prose-slate max-w-none text-[14px] md:text-[15px] leading-relaxed">
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li dangerouslySetInnerHTML={{ __html: post.li1 }}></li>
              <li dangerouslySetInnerHTML={{ __html: post.li2 }}></li>
            </ul>
